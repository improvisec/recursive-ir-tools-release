...
The UAL Processor can ingest unified audit log files in json format. It is possible to process say, one year or more worth of audit logs to identify suspicious activities which happened in a given tenant further back in time. 
